...
function convertHalf(showHalfCard) {
	if (showHalfCard == "CHINESE_HALF") {
		return CHINESE_HALF;
	} else if (showHalfCard == "ENGLISH_HALF") {
		return ENGLISH_HALF;
	} else {
		return RANDOM_HALF
	}
...
function convertOrder(cardOrder) {
	if (cardOrder == "RANDOM") {
		return RANDOM;
	} else {
		return SEQUENTIAL;
...
function Cards(cardOrder, showHalfCard) {
	this.cardOrder = convertOrder(cardOrder);
	this.showHalfCard = convertHalf(showHalfCard);
	this.length = 0;
	this.index = -1;
